...
import starwars.game.math.MatrixUtils;
...
public class BaseScreen implements Screen, InputProcessor {
    ...
    public void resize(Rect worldBounds) {
        System.out.printf("worldBounds width = " + worldBounds.getWidth() + "worldBounds height =" + worldBounds.getHeight());
    ...
    public boolean touchDown(Vector2 touch, int pointer, int button) {
        System.out.println("touchDown touchX =" + touch.x + "touchDown touchY = " + touch.y);
        return false;
    }
