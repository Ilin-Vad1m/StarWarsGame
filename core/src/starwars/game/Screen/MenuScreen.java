...
import starwars.game.sprite.Star;
import starwars.game.base.BaseScreen;
import starwars.game.sprite.Background3;
import starwars.game.sprite.Background4;
import starwars.game.sprite.ButtonExit;
import starwars.game.sprite.ButtonOptions;
import starwars.game.sprite.ButtonPlay;
import starwars.game.sprite.MenuNameGame;
...
public class MenuScreen extends BaseScreen {
    ...
    private starwars.game.sprite.Star[] stars;
    ...
    public void show() {
        ...
        stars = new starwars.game.sprite.Star[STAR_COUNT];
        atlasStars = new TextureAtlas(Gdx.files.internal("stars/stars.atlas"));
        for (int i = 0; i < STAR_COUNT; i++) {
            stars[i] = new starwars.game.sprite.Star(atlasStars);
        }
    ...
    public void resize(Rect worldBounds) {
        ...
        for(starwars.game.sprite.Star star : stars){
